 ...
 */
export const onDataReadHandler = onDocumentCreated("events/{eventId}", async (event) => {
  ...
  logger.info(`🔍 Evaluando riesgo para comuna ${medicion.comuna} con AQI ${medicion.aqi}`);
